...
// Service and location data remains the same
...
const LaserPackageCalculator = () => {
  ...
  const updateService = (index, field, value) => {
    ...
    // Reset payment plan if changing from standard to touchup or vice versa
  ...
  // JSX remains mostly the same but with updated service rendering
  return (
    <Card className="w-full max-w-4xl mx-auto bg-[#f4f3f6] font-poppins shadow-lg">
      ...
      <CardContent className="p-8 space-y-8">
        ...
        {/* Service List with Package Selection */}
